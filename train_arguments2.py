### Train arguments for train_model2.py and run_train_model_noeval.sh 
import argparse
...
def parse_args():
    ...
    parser.add_argument("--thresholds_file_path", type=str, required=True, help="Best Class Thresholds JSON file path")
    ...
    # parser.add_argument("--gradient_checkpointing", default=False, required=False, help="Use gradient checkpointing to save memory at the expense of slower backward pass")
